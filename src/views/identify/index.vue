<template>
  <div style="position:relative">
    ...
    <CustomConfirm :data='customData' @click='CustomClick'></CustomConfirm>
  </div>
</template>
<script>
  ...
  import CustomConfirm from '../../components/XConfirm/XConfirm'
  export default {
    mixins: [myMixin],
    components: {
      Group,
    ...
    methods: {
      ...
      gotoIdentify() { // 跳转达到ocr页面，传递ocrType为1
        ...
        params.ocrType = 1
        this.$router.push({
          path: '/authentication/identify/setPhoto',
          query: params
        })
      },
      submit() {
